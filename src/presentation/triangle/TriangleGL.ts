...
class LazyTriangle extends Lazy<TriangleGL> {
...
`;
    ...
    initializer(): TriangleGL {
        return new TriangleGL(getCanvas(),this.VertexShader,this.FragmentShader);
    }
}

export{
    TriangleGL,LazyTriangle
}